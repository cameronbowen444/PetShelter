    ...
    <div className={styles.page}>
      <div className={styles.topBar}>
        <div>
          ...
          <h2>Update {name || "Pet"}</h2>
          <p>Make changes carefully before saving this pet’s profile.</p>
        </div>
            ...
            <section className={styles.formSection}>
              <div className={styles.sectionHeading}>
                ...
                <div>
                  ...
                  <p>Update the main details shown to visitors.</p>
                </div>
              </div>
              ...
              <div className={styles.formGroup}>
                ...
                <div className={styles.helperRow}>
                  {errors.description ? (
                    ...
                    <p className={styles.helperText}>Minimum 10 characters.</p>
                  )}
            ...
            <section className={`${styles.formSection} ${styles.softSection}`}>
              <div className={styles.sectionHeading}>
                ...
                <div>
                  ...
                  <p>Update fun skills, tricks, or personality traits.</p>
                </div>
              </div>
              ...
              <div className={styles.formTip}>
                <span>🩵</span>
                <p>
                  A clear profile helps this pet stand out and makes adoption
                  easier for visitors.
                </p>
              </div>
            </section>
      ...
      <ConfirmModal
        ...
        message={`${name || "This pet"}’s changes will be saved to the shelter list.`}
        confirmText="Update Pet"
        variant="primary"
